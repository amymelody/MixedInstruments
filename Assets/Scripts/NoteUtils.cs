...
{
    public static float[] FundementalFrequencies = new float[]
    {   // C      // CSharp                                                                                           // B
    ...
    public static float GetFundamentalFrequency(this Note note)
    {
        return FundementalFrequencies[note.Octave * 12 + (int)note.NoteName];
    }
}
