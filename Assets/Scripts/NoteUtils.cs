...
{
    // source: https://github.com/IRCSS/Procedural-Sound/blob/master/Assets/Scripts/Maps/KeyIndeciesToFrequencies.cs
    // adjusted to account for MIDI note 0 starting at octave -1
    public static float[] FundamentalFrequencies = new float[]
    {   // C      // C#                                                                                               // B
        8.18f,    8.66f,    9.18f,    9.73f,    10.30f,   10.92f,   11.56f,   12.25f,   12.98f,   13.75f,   14.57f,   15.44f,   // -1
        ...
        4186.01f, 4434.92f, 4698.63f, 4978.03f, 5274.04f, 5587.65f, 5919.91f, 6271.93f, 6648.88f, 7040.00f, 7458.62f, 7902.14f  // 8
    };
}
